...
pthread_t threadtemp;	 //thread for pingfrom SARA
int id1=1;
int id2=1;
int id3=1;
...
void* threadFunc3(void* thread_data)	 //thread for temperature
{
float temp1, temp2, temp3, temp4, temp5;
	for (;;)
	{
		...
		temp3=Read_Temp(2);
		temp4=Read_Temp(3);
		temp5=Read_Pressuare_Temp();
		printf("\r\n================================================================== Temperature sensors =============================================================================\r\n");
		printf("sensor #1 = %.2f		sensor #2 = %.2f		sensor #3 = %.2f		sensor #4 = %.2f		pressure_sensor = %.2f", temp1, temp2, temp3, temp4, temp5);
		printf("\r\n====================================================================================================================================================================\r\n");
		sleep(5);
	}
}
...
int main(int argc, char* argv[])
{
	...
	if (argc!=4)
	{
	printf ("Please usage: power_test <MAC for bluetooth> <charge level> <APN>\r\n");
	exit (0);
	}
	...
	trhread_state=pthread_create(&threadtemp, NULL, threadFunc3, &id3);
	if (trhread_state==0)
	{
